...
Hybrid functional uses a mixture of  non-local Hartree-Fock exchange with local or semi-local DFT exchange. The exchange functional in standard DFT was only approximated under LDA and GGA functional (i.e. eqn  \eqref{eq:Dirac-ex}). However, the exact exchange is given previously in equation  \eqref{eq:HF-ex}.

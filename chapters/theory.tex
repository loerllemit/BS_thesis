...
\begin{equation}
    \hat{\mathcal{H}} = \hat{\mathcal{T}_n} + \hat{\mathcal{T}_e} + \hat{\mathcal{U}}_{en} + \hat{\mathcal{U}}_{ee}  + \hat{\mathcal{U}}_{nn} 
\end{equation}
where the $\hat{\mathcal{T}}$ and $\hat{\mathcal{U}}$ refer to kinetic energy and potential energy, respectively, and the labels $e$ and $n$ denotes the electronic and nuclear coordinates and their derivatives, respectively.  This equation can be expanded as 

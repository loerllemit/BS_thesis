...
Vacancies, interstitals, Schottky defect, Frenkel defect, and antisite which do not involve any foreign atoms are called  native point defects. Otherwise, interstitials and substitutionals involving foreign atoms are called extrinsic point defects. Figure \ref{fig:point_defects} illustrates various point defects present in a material. A useful notation for dealing with point defects is the use of  Kröger-Vink notation \citep{Kroeger1964}. The general notation can  be expressed as  $X_Y^Z$ where $X$ is element symbol for an atomic species located on a site, else it is written $V$ for vacancy. The $Y$ is the type of site occupied by X; $i$ for an interstitial, otherwise, element symbol for site normally occupied by this element. Lastly $Z$ is the charge of defect normally written as $'$ or $-$ for negative charge; $\cdot$ or $+$ for positive charge; while $x$, $0$ or sometimes omitted for neutral charge. For instance, an oxygen antisite in ZnO crystal with a $2-$ charge state can be written as \ch{O}$_{\ch{Zn}}^{2-}$. A $1+$ oxygen vacancy is expressed as $V_{\ch{O}}^{+}$.
...
\begin{figure}[H]
	\centering
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/perfect"}
			\caption{Perfect lattice}
		\end{subfigure}
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/vacancy"}
			\caption{Vacancy defect}
		\end{subfigure}
		...
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/interstitial"}
			\caption{Interstitial defect}
		\end{subfigure}
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/substitutional"}
			\caption{Substitutional defect}
		\end{subfigure}
		...
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/frenkel"}
			\caption{Frenkel defect}
		\end{subfigure}
		\begin{subfigure}{0.48\textwidth} 
			\centering
			\includegraphics[width=0.9\linewidth]{"images/rrl/schottky"}
			\caption{Schottky defect}
		\end{subfigure}
	\caption[Various point defects in real materials]{Various point defects in real materials. Figures were  plotted using VESTA software \citep{Momma2008}. }  

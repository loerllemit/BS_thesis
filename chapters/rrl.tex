...
There has been a great deal of interest in studying the point defects in ZnO due to its promising features in optoelectronics. For instance, the luminescence properties of ZnO can be controlled by doping an impurity atom \citep{Musavi2019}.  However, some questions were remained unanswered or not yet convincingly addressed. The observed n-type conductivity in ZnO were 

For instance, the well known green luminescence band, manifesting as a broad peak around 500-530 nm,  observed in nearly all ZnO samples regardless of the fabrication techniques have been the topic of debate whether this is caused by the native defects or due to uncontrollable impurities during growth. 
